...
class NewIncomePage extends StatefulWidget {
  NewIncomePage({Key key, @required this.id, @required this.familyId, @required this.user})
      : super(key: key);
  final String id;
  ...
  @override
  _NewIncomePageState createState() => _NewIncomePageState(id, familyId, user);
}

class _NewIncomePageState extends State<NewIncomePage> {
  _NewIncomePageState(this._id, this.familyID, this._user);
  final String _id;
  final String  familyID;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      drawer: MenuProvider(id: _id, currentPage: 'NewIncomePage', user: _user),
