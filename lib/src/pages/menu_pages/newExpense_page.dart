...
class NewExpensePage extends StatefulWidget {
  NewExpensePage({Key key, @required this.id}) : super(key: key);
  final String id;

  @override
  _NewExpensePageState createState() => _NewExpensePageState(id);
}

class _NewExpensePageState extends State<NewExpensePage> {
  _NewExpensePageState(this._id);
  final String _id;
