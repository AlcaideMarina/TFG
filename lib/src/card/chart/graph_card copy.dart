...
class Graph2Card extends StatefulWidget {
  ...
  Graph2Card({Key key, @required this.lista});
  List<dynamic> lista;

  @override
  State<StatefulWidget> createState() => _Graph2CardState(this.lista);
}

class _Graph2CardState extends State<Graph2Card> {
  _Graph2CardState(this.lista);
  List<dynamic> lista;
  ...
  BarChartGroupData makeGroupData(
    ...
    return BarChartGroupData(
      ...
      barRods: [
        BarChartRodData(
          y: isTouched ? y + 1 : y,
          colors: isTouched ? [Colors.greenAccent] : [barColor],
          width: width,
